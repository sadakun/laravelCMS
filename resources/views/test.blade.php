            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item fas fa-power-off" href="{{ route('logout') }}" onclick="event.preventDefault();
        ...
        <aside class="main-sidebar elevation-4 sidebar-light-olive">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-0 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('images/img/user2-160x160.jpg') }}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
